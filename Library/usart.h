...
#define fclk 									8
#define Baud									9600
#define Div         				 ((fclk) / (16 * (Baud/pow(1000,2))))
...
void usartInit(USART_TypeDef *usart,uint32_t br);
void Send_String(USART_TypeDef *uart,unsigned char *str);
unsigned char GetChar (USART_TypeDef *urt);
void SendChar (USART_TypeDef *uart,unsigned char ch);
void dma_read(USART_TypeDef *__USART,char *data, int size);
void dma_write(USART_TypeDef *_USART,char *data, int size);
#endif
