...
#define AFIO_CLOCKEN              1 << 0    //enable clock to port E
/********************************************/
//GPIO Data Structures
//Functions prototypes
void  portInit(GPIO_TypeDef *PT,uint16_t __val);
void  portInitAlt(GPIO_TypeDef *PT,uint16_t _val);
uint16_t  portRead(GPIO_TypeDef *PORT,uint16_t pin);
void  Set_clock(GPIO_TypeDef *GIO);
void  portWrite(GPIO_TypeDef *PORT,uint16_t value);
#endif
